...
> Forked from [Sublime Bookmarks](https://github.com/dreikanter/sublime-bookmarks)
...
- [SFTP](http://wbond.net/sublime_packages/sftp) - FTP, FTPS and SFTP support
- [Git Savvy](https://github.com/divmain/GitSavvy) - Full git and GitHub integration
...
- [ApplySyntax](https://github.com/facelessuser/ApplySyntax) — a plugin that allows to detect and apply the syntax of files that might not otherwise be detected properly
